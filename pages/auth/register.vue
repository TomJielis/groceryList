...
<template>
  <div class="fixed inset-0 md:pt-16 flex items-start justify-center bg-gradient-to-b from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 px-4 py-4 md:py-8 overflow-y-auto">
        ...
        <div class="p-6">
          <div v-if="!verifyMailMessage">
            <form @submit.prevent="handleRegister" class="space-y-4">
              ...
              <!-- Terms Checkbox -->
              <label class="flex items-start gap-3 p-3 bg-slate-50 dark:bg-slate-900 rounded-lg border border-slate-200 dark:border-slate-700">
                <input
                  type="checkbox"
