...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  async setup(__props) {
    ...
    [__temp, __restore] = withAsyncContext(() => getCards()), await __temp, __restore();
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a2, _b;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-[90vh] p-8 overflow-auto" }, _attrs))}><div class="max-w-3xl mx-auto"><h1 class="text-3xl font-bold text-green-700 mb-6 text-center"> Grocery Shopping List Dashboard </h1><div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">`);
      ...
      _push(ssrRenderComponent(_sfc_main$1, {
        title: "cards",
        count: unref(cards).length,
        onClick: ($event) => _ctx.$router.push("/cards/"),
        class: "cursor-pointer"
      }, null, _parent));
      if (((_a2 = unref(authStore).user) == null ? void 0 : _a2.favorite_list_id) > 0) {
        _push(ssrRenderComponent(_sfc_main$1, {
      ...
      if (((_b = unref(authStore).user) == null ? void 0 : _b.favorite_list_id) === null) {
        _push(ssrRenderComponent(_sfc_main$1, {
          title: "Lists",
          onClick: ($event) => _ctx.$router.push("/list/lists"),
...
//# sourceMappingURL=index-D20FGvVP.js.map
