...
<template>
  <nav class="fixed bottom-0 left-0 right-0 bg-green-500 flex justify-around items-center p-3 shadow-md md:hidden h-20">
    ...
    <nuxtLink v-if="authStore.user" to="/profile" class="text-center flex-1">
